...
using FMatrix = Microsoft.Xna.Framework.Matrix;
    ...
    public class FarseerDebugViewUnity : DebugView, IDisposable
    {
        ...
        private void PreSolve(Contact contact, ref Manifold oldManifold)
        {
            if ((Flags & DebugViewFlags.ContactPoints) == DebugViewFlags.ContactPoints)
            {
                ...
                VelcroPhysics.Collision.Narrowphase.Collision.GetPointStates(out state1, out state2, ref oldManifold, ref manifold);
        ...
        private void DrawJoint(Joint joint)
        {
            ...
            switch (joint.JointType)
            {
                ...
                case JointType.Pulley:
                    ...
                    FVector2 s1 = pulley.WorldAnchorA;
                    FVector2 s2 = pulley.WorldAnchorB;
