...
public class TestCoreCollisionEvents : MonoBehaviour
{
	...
	void Update ()
	{
		...
		else
		{
			...
			foreach(Contact lastContact in lastContacts)
			{
				...
				FixedArray2<FVector2> contactPoints;
				FVector2 normal;
				...
				if(isTouching)
				{
					...
					VelcroPhysics.Shared.Optimization.FixedArray2<ManifoldPoint> lpp = lastContact.Manifold.Points;
	...
	private void OnCollisionEvent(Fixture fixtureA, Fixture fixtureB, Contact contact)
	{
