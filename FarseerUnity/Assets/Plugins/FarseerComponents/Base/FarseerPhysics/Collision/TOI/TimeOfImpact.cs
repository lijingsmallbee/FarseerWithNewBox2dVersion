    ...
    public static class TimeOfImpact
    {
        ...
        public static void CalculateTimeOfImpact(ref TOIInput input, out TOIOutput output)
        {
            ...
            for (;;)
            {
                ...
                SeparationFunction.Initialize(ref cache, input.ProxyA, ref sweepA, input.ProxyB, ref sweepB, t1, out FVector2 axis, out FVector2 localPoint, out SeparationFunctionType type);
