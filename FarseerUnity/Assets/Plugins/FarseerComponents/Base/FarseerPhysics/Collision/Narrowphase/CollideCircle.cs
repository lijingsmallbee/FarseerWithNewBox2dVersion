...
namespace VelcroPhysics.Collision.Narrowphase
{
    public static class CollideCircle
    {
        ...
        public static void CollidePolygonAndCircle(ref Manifold manifold, PolygonShape polygonA, ref Transform xfA, CircleShape circleB, ref Transform xfB)
        {
            ...
            {
                float s = FVector2.Dot(normals[i], cLocal - vertices[i]);
            ...
            FVector2 v1 = vertices[vertIndex1];
            FVector2 v2 = vertices[vertIndex2];
            ...
            float u1 = FVector2.Dot(cLocal - v1, v2 - v1);
            float u2 = FVector2.Dot(cLocal - v2, v1 - v2);
            ...
            else
            {
                ...
                float s = FVector2.Dot(cLocal - faceCenter, normals[vertIndex1]);
                if (s > radius)
                {
                    return;
                }
