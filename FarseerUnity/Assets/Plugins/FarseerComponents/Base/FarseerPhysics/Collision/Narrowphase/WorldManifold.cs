...
namespace VelcroPhysics.Collision.Narrowphase
{
    public static class WorldManifold
    {
        ...
        /// </summary>
        public static void Initialize(ref Manifold manifold, ref Transform xfA, float radiusA, ref Transform xfB, float radiusB, out FVector2 normal, out FixedArray2<FVector2> points, out FixedArray2<float> separations)
        {
                ...
                case ManifoldType.Circles:
                    {
                        ...
                        FVector2 pointB = MathUtils.Mul(ref xfB, manifold.Points.Value0.LocalPoint);
