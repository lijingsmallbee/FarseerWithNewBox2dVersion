...
namespace VelcroPhysics.Collision.Narrowphase
{
    ...
    public static class Collision
    {
        ...
        /// <returns></returns>
        internal static int ClipSegmentToLine(out FixedArray2<ClipVertex> vOut, ref FixedArray2<ClipVertex> vIn, FVector2 normal, float offset, int vertexIndexA)
        {
            ...
            float distance0 = FVector2.Dot(normal, vIn.Value0.V) - offset;
            float distance1 = FVector2.Dot(normal, vIn.Value1.V) - offset;
