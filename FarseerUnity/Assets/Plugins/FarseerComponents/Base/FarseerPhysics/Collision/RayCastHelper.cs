...
namespace VelcroPhysics.Collision.RayCast
{
    ...
    {
        public static bool RayCastEdge(ref FVector2 start, ref FVector2 end, ref RayCastInput input, ref Transform transform, out RayCastOutput output)
        {
            // p = p1 + t * d
            // v = v1 + s * e
            // p1 + t * d = v1 + s * e
            ...
            FVector2 v2 = end;
            FVector2 e = v2 - v1;
            FVector2 normal = new FVector2(e.Y, -e.X); //TODO: Could possibly cache the normal.
            normal.Normalize();
        ...
        public static bool RayCastCircle(ref FVector2 pos, float radius, ref RayCastInput input, ref Transform transform, out RayCastOutput output)
        {
            ...
            FVector2 position = transform.p + MathUtils.Mul(transform.q, pos);
