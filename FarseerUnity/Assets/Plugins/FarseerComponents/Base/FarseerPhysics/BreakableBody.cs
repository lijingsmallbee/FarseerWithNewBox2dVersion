...
namespace VelcroPhysics.Dynamics
{
    ...
    public class BreakableBody
    {
        ...
        public BreakableBody(World world, IEnumerable<Vertices> vertices, float density, FVector2 position = new FVector2(), float rotation = 0)
        {
            _world = world;
        ...
        public BreakableBody(World world, IEnumerable<Shape> shapes, FVector2 position = new FVector2(), float rotation = 0)
        {
            _world = world;
            _world.ContactManager.PostSolve += PostSolve;
            MainBody = BodyFactory.CreateBody(_world, position, rotation, BodyType.Dynamic);
