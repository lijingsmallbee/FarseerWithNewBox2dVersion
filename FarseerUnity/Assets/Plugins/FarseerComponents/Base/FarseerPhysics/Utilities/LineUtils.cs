...
namespace VelcroPhysics.Utilities
{
    ...
    {
        public static float DistanceBetweenPointAndLineSegment(ref FVector2 point, ref FVector2 start, ref FVector2 end)
        {
            if (start == end)
                return FVector2.Distance(point, start);

            FVector2 v = FVector2.Subtract(end, start);
            FVector2 w = FVector2.Subtract(point, start);
            ...
            float b = c1 / c2;
            FVector2 pointOnLine = FVector2.Add(start, FVector2.Multiply(v, b));
        ...
        /// </summary>
        public static bool LineIntersect2(ref FVector2 a0, ref FVector2 a1, ref FVector2 b0, ref FVector2 b1, out FVector2 intersectionPoint)
        {
        ...
        public static bool LineIntersect(ref FVector2 point1, ref FVector2 point2, ref FVector2 point3, ref FVector2 point4, bool firstIsSegment, bool secondIsSegment, out FVector2 point)
        {
            point = new FVector2();
        ...
        /// </param>
        /// <returns>True if an intersection is detected, false otherwise.</returns>
        public static bool LineIntersect(FVector2 point1, FVector2 point2, FVector2 point3, FVector2 point4, bool firstIsSegment, bool secondIsSegment, out FVector2 intersectionPoint)
        {
        ...
        /// </param>
        /// <returns>True if an intersection is detected, false otherwise.</returns>
        public static bool LineIntersect(ref FVector2 point1, ref FVector2 point2, ref FVector2 point3, ref FVector2 point4, out FVector2 intersectionPoint)
        {
        ...
        /// </param>
        /// <returns>True if an intersection is detected, false otherwise.</returns>
        public static bool LineIntersect(FVector2 point1, FVector2 point2, FVector2 point3, FVector2 point4, out FVector2 intersectionPoint)
        {
            return LineIntersect(ref point1, ref point2, ref point3, ref point4, true, true, out intersectionPoint);
        }
