...
namespace VelcroPhysics.Shared
{
    ...
    public struct Mat33
    {
        ...
        public FVector3 Solve33(FVector3 b)
        {
            ...
            return new FVector3(det * FVector3.Dot(b, FVector3.Cross(ey, ez)), det * FVector3.Dot(ex, FVector3.Cross(b, ez)), det * FVector3.Dot(ex, FVector3.Cross(ey, b)));
        }
        ...
        {
            float det = MathUtils.Dot(ex, MathUtils.Cross((FVector3)ey, ez));
            if (det != 0.0f)
            {
                det = 1.0f / det;
            }
