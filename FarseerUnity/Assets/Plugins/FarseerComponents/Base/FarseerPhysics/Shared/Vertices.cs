...
namespace VelcroPhysics.Shared
{
    ...
    public class Vertices : List<FVector2>
    {
        ...
        public FVector2 GetCentroid()
        {
            //The simplest polygon which can exist in the Euclidean plane has 3 sides.
            if (Count < 3)
                return new FVector2(float.NaN, float.NaN);
            ...
            {
                // Triangle vertices.
                FVector2 current = this[i];
                FVector2 next = (i + 1 < Count ? this[i + 1] : this[0]);
        ...
        public void Translate(ref FVector2 value)
        {
            ...
            for (int i = 0; i < Count; i++)
                this[i] = FVector2.Add(this[i], value);
        ...
        public bool IsConvex()
        {
            ...
            for (int i = 0; i < Count; ++i)
            {
                ...
                FVector2 edge = this[next] - this[i];
        ...
        public bool IsSimple()
        {
            ...
            {
                FVector2 a1 = this[i];
                FVector2 a2 = NextVertex(i);
                for (int j = i + 1; j < Count; ++j)
                {
                    FVector2 b1 = this[j];
                    FVector2 b2 = NextVertex(j);
