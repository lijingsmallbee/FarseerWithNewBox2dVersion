    ...
    public class ContactSolver
    {
        ...
        public void InitializeVelocityConstraints()
        {
            for (int i = 0; i < _count; ++i)
            {
                ...
                WorldManifold.Initialize(ref manifold, ref xfA, radiusA, ref xfB, radiusB, out FVector2 normal, out FixedArray2<FVector2> points, out _);
        ...
        public bool SolvePositionConstraints()
        {
            ...
            for (int i = 0; i < _count; ++i)
            {
                ...
                for (int j = 0; j < pointCount; ++j)
                {
                    ...
                    PositionSolverManifold.Initialize(pc, xfA, xfB, j, out FVector2 normal, out FVector2 point, out float separation);
