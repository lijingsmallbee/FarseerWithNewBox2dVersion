    ...
    public class Island
    {
        ...
        public void Solve(ref TimeStep step, ref FVector2 gravity)
        {
            ...
            for (int i = 0; i < BodyCount; ++i)
            {
                ...
                FVector2 c = b._sweep.C;
                float a = b._sweep.A;
                FVector2 v = b._linearVelocity;
            ...
            for (int i = 0; i < BodyCount; ++i)
            {
                FVector2 c = Positions[i].C;
                float a = Positions[i].A;
                FVector2 v = Velocities[i].V;
            ...
            if (Settings.AllowSleep)
            {
                ...
                for (int i = 0; i < BodyCount; ++i)
                {
                    ...
                    if (!b.SleepingAllowed || b._angularVelocity * b._angularVelocity > AngTolSqr || FVector2.Dot(b._linearVelocity, b._linearVelocity) > LinTolSqr)
                    {
                        b.SleepTime = 0.0f;
                        minSleepTime = 0.0f;
                    }
