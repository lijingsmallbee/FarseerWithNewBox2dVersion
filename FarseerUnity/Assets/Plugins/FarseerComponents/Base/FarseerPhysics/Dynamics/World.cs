...
namespace VelcroPhysics.Dynamics
{
    ...
    public class World
    {
        ...
        private Func<Fixture, FVector2, FVector2, float, float> _rayCastCallback;
        ...
        private float RayCastCallbackWrapper(RayCastInput rayCastInput, int proxyId)
        {
            ...
            if (hit)
            {
                ...
                FVector2 point = (1.0f - fraction) * rayCastInput.Point1 + fraction * rayCastInput.Point2;
        ...
        public void RayCast(Func<Fixture, FVector2, FVector2, float, float> callback, FVector2 point1, FVector2 point2)
        {
