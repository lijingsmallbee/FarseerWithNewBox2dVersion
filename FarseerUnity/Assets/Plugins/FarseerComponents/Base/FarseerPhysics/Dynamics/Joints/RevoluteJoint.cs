...
namespace VelcroPhysics.Dynamics.Joints
{
    ...
    public class RevoluteJoint : Joint
    {
        ...
        public RevoluteJoint(Body bodyA, Body bodyB, FVector2 anchorA, FVector2 anchorB, bool useWorldCoordinates = false)
            : base(bodyA, bodyB)
        {
            JointType = JointType.Revolute;
        ...
        public RevoluteJoint(Body bodyA, Body bodyB, FVector2 anchor, bool useWorldCoordinates = false)
        ...
        internal override void SolveVelocityConstraints(ref SolverData data)
        {
            ...
            {
                FVector2 Cdot1 = vB + MathUtils.Cross(wB, _rB) - vA - MathUtils.Cross(wA, _rA);
                float Cdot2 = wB - wA;
                FVector3 Cdot = new FVector3(Cdot1.X, Cdot1.Y, Cdot2);

                FVector3 impulse = -_mass.Solve33(Cdot);
                ...
                else if (_limitState == LimitState.AtLower)
                {
                    ...
                    if (newImpulse < 0.0f)
                    {
                        FVector2 rhs = -Cdot1 + _impulse.Z * new FVector2(_mass.ez.X, _mass.ez.Y);
                        FVector2 reduced = _mass.Solve22(rhs);
                        impulse.X = reduced.X;
                        impulse.Y = reduced.Y;
            ...
            else
            {
                ...
                FVector2 impulse = _mass.Solve22(-Cdot);
