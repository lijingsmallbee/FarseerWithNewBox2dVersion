...
namespace VelcroPhysics.Dynamics.Joints
{
    ...
    public class MotorJoint : Joint
    {
        ...
        internal override void SolveVelocityConstraints(ref SolverData data)
        {
            ...
            {
                FVector2 Cdot = vB + MathUtils.Cross(wB, _rB) - vA - MathUtils.Cross(wA, _rA) + inv_h * CorrectionFactor * _linearError;

                FVector2 impulse = -MathUtils.Mul(ref _linearMass, ref Cdot);
