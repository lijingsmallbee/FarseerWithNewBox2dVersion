...
namespace VelcroPhysics.Dynamics.Joints
{
    ...
    public class WeldJoint : Joint
    {
        ...
        public WeldJoint(Body bodyA, Body bodyB, FVector2 anchorA, FVector2 anchorB, bool useWorldCoordinates = false)
            : base(bodyA, bodyB)
        {
            JointType = JointType.Weld;
        ...
        internal override bool SolvePositionConstraints(ref SolverData data)
        {
            ...
            else
            {
                ...
                {
                    FVector2 impulse2 = -K.Solve22(C1);
                    impulse = new FVector3(impulse2.X, impulse2.Y, 0.0f);
                }
