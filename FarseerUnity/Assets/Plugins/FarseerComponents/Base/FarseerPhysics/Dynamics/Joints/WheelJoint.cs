...
namespace VelcroPhysics.Dynamics.Joints
{
    ...
    public class WheelJoint : Joint
    {
        ...
        public WheelJoint(Body bodyA, Body bodyB, FVector2 anchor, FVector2 axis, bool useWorldCoordinates = false)
            : base(bodyA, bodyB)
        {
            JointType = JointType.Wheel;
        ...
        public float JointTranslation
        {
            get
            {
                ...
                FVector2 d = pB - pA;
                FVector2 axis = bA.GetWorldVector(LocalXAxis);
        ...
        public float JointLinearSpeed
        {
            get
            {
                ...
                FVector2 rA = MathUtils.Mul(xfA.q, LocalAnchorA - bA._sweep.LocalCenter);
                FVector2 rB = MathUtils.Mul(xfB.q, LocalAnchorB - bB._sweep.LocalCenter);
                FVector2 p1 = bA._sweep.C + rA;
                FVector2 p2 = bB._sweep.C + rB;
                FVector2 d = p2 - p1;
                FVector2 axis = MathUtils.Mul(xfA.q, LocalXAxis);

                FVector2 vA = bA.LinearVelocity;
                FVector2 vB = bB.LinearVelocity;
                float wA = bA.AngularVelocity;
                float wB = bB.AngularVelocity;

                float speed = FVector2.Dot(d, MathUtils.Cross(wA, axis)) + FVector2.Dot(axis, vB + MathUtils.Cross(wB, rB) - vA - MathUtils.Cross(wA, rA));
                return speed;
            }
        }
        ...
        internal override void InitVelocityConstraints(ref SolverData data)
        {
            ...
            if (Settings.EnableWarmstarting)
            {
                ...
                FVector2 P = _impulse * _ay + _springImpulse * _ax;
        ...
        internal override void SolveVelocityConstraints(ref SolverData data)
        {
            ...
            {
                float Cdot = FVector2.Dot(_ax, vB - vA) + _sBx * wB - _sAx * wA;
                float impulse = -_springMass * (Cdot + _bias + _gamma * _springImpulse);
                _springImpulse += impulse;

                FVector2 P = impulse * _ax;
            ...
            {
                float Cdot = FVector2.Dot(_ay, vB - vA) + _sBy * wB - _sAy * wA;
                float impulse = -_mass * Cdot;
                _impulse += impulse;

                FVector2 P = impulse * _ay;
        ...
        internal override bool SolvePositionConstraints(ref SolverData data)
        {
            ...
            FVector2 ay = MathUtils.Mul(qA, _localYAxis);
