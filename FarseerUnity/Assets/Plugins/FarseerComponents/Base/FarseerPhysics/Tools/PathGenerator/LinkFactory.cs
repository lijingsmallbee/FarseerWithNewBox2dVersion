...
namespace VelcroPhysics.Tools.PathGenerator
{
    public static class LinkFactory
    {
        ...
        /// </param>
        /// <returns></returns>
        public static Path CreateChain(World world, FVector2 start, FVector2 end, float linkWidth, float linkHeight, int numberOfLinks, float linkDensity, bool attachRopeJoint)
        {
            ...
            PathManager.AttachBodiesWithRevoluteJoint(world, chainLinks, new FVector2(0, -linkHeight), new FVector2(0, linkHeight), false, false);

            if (attachRopeJoint)
                JointFactory.CreateRopeJoint(world, chainLinks[0], chainLinks[chainLinks.Count - 1], FVector2.Zero, FVector2.Zero);
