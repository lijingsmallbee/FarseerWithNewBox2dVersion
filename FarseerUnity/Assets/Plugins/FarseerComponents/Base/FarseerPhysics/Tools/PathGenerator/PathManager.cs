    ...
    public static class PathManager
    {
        ...
        public static List<Body> EvenlyDistributeShapesAlongPath(World world, Path path, IEnumerable<Shape> shapes, BodyType type, int copies, object userData = null)
        {
            ...
            for (int i = 0; i < centers.Count; i++)
            {
                ...
                Body b = BodyFactory.CreateBody(world, new FVector2(centers[i].X, centers[i].Y), centers[i].Z, type, userData);
        ...
        public static List<RevoluteJoint> AttachBodiesWithRevoluteJoint(World world, List<Body> bodies, FVector2 localAnchorA, FVector2 localAnchorB, bool connectFirstAndLast, bool collideConnected)
        {
