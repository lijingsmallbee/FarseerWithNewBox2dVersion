...
namespace VelcroPhysics.Factories
{
    ...
    public static class JointFactory
    {
        ...
        public static RopeJoint CreateRopeJoint(World world, Body bodyA, Body bodyB, FVector2 anchorA, FVector2 anchorB, bool useWorldCoordinates = false)
        {
        ...
        public static WeldJoint CreateWeldJoint(World world, Body bodyA, Body bodyB, FVector2 anchorA, FVector2 anchorB, bool useWorldCoordinates = false)
        {
        ...
        public static PrismaticJoint CreatePrismaticJoint(World world, Body bodyA, Body bodyB, FVector2 anchor, FVector2 axis, bool useWorldCoordinates = false)
        {
        ...
        public static PulleyJoint CreatePulleyJoint(World world, Body bodyA, Body bodyB, FVector2 anchorA, FVector2 anchorB, FVector2 worldAnchorA, FVector2 worldAnchorB, float ratio, bool useWorldCoordinates = false)
        {
        ...
        public static FixedMouseJoint CreateFixedMouseJoint(World world, Body body, FVector2 worldAnchor)
        {
        ...
        public static RevoluteJoint CreateRevoluteJoint(World world, Body bodyA, Body bodyB, FVector2 anchorA, FVector2 anchorB, bool useWorldCoordinates = false)
        {
        ...
        {
            FVector2 localanchorA = bodyA.GetLocalPoint(bodyB.GetWorldPoint(anchor));
        ...
        public static WheelJoint CreateWheelJoint(World world, Body bodyA, Body bodyB, FVector2 anchor, FVector2 axis, bool useWorldCoordinates = false)
        {
        ...
        public static WheelJoint CreateWheelJoint(World world, Body bodyA, Body bodyB, FVector2 axis)
        {
            return CreateWheelJoint(world, bodyA, bodyB, FVector2.Zero, axis);
        }
        ...
        public static DistanceJoint CreateDistanceJoint(World world, Body bodyA, Body bodyB, FVector2 anchorA, FVector2 anchorB, bool useWorldCoordinates = false)
        {
        ...
        {
            return CreateDistanceJoint(world, bodyA, bodyB, FVector2.Zero, FVector2.Zero);
        }
        ...
        public static FrictionJoint CreateFrictionJoint(World world, Body bodyA, Body bodyB, FVector2 anchor, bool useWorldCoordinates = false)
        {
        ...
        {
            return CreateFrictionJoint(world, bodyA, bodyB, FVector2.Zero);
        }
