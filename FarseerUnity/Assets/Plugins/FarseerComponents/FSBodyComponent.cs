...
public class FSBodyComponent : MonoBehaviour
{
    ...
    //    body = BodyFactory.CreateRectangle(FSWorldComponent.PhysicsWorld, 1f, 1f, Density);
        var dynamicTemp = new BodyTemplate();
        dynamicTemp.Type = BodyType.Dynamic;
		body = new Body(FSWorldComponent.PhysicsWorld,dynamicTemp);
        ...
        FSWorldComponent.PhysicsWorld.AddBody(body);
