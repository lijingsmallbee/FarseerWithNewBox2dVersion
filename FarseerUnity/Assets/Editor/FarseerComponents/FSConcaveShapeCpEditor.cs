...
using Category = VelcroPhysics.Collision.Filtering.Category;
...
public class FSConcaveShapeCpEditor : Editor
{
	...
	protected virtual void ConvertToConvex(FSConcaveShapeComponent targetCSC)
	{
        ...
        // convert vertices
        var concaveVertices = new VelcroPhysics.Shared.Vertices();
        ...
        var al = VelcroPhysics.Tools.Triangulation.TriangulationBase.TriangulationAlgorithm.Bayazit;
		List< VelcroPhysics.Shared.Vertices> convexShapeVs = VelcroPhysics.Tools.Triangulation.TriangulationBase.Triangulate.ConvexPartition(concaveVertices,al);
